...
option_list = list(
  ...
  make_option(c("-v","--heritability"), type="double", default="0.5",help="heritability",metavar="character"),
  make_option(c("-r","--ratio"), type="double", default="1",help="male to female env var ratio",metavar="character")
)
